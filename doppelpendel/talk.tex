...
\frame {
    ...
    \includegraphics[scale=0.35]{doublependulum.png}
    
    \hfill
    \hrule
    \ \\
    {\footnotesize Bildquelle: \href{http://de.wikipedia.org/wiki/Doppelpendel}{Wikipedia} }
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
    \begin{align}
...
\frame {
    ...
    \begin{itemize}
    \item Aufstellen der Bewegungsgleichung mit Lagrange
    \begin{equation}
    \nonumber
    L = T - V
    \end{equation}
    ...
    \begin{align}
    \nonumber
    L =& mL^2\dot{\theta}_1^2 + \frac{1}{2}mL^2\dot{\theta}_2^2 + mL^2\dot{\theta}_1\dot{\theta}_2\cos{(\theta_1-\theta_2)}  \\
    \nonumber
...
\frame {
    ...
    \begin{center}
    \includemovie[poster,autoplay,controls=true]{7.5cm}{7.5cm}{periodisch.mpeg}
...
\frame {
    ...
    \begin{center}
    \includemovie[poster,autoplay,controls=true]{7.5cm}{7.5cm}{periodisch_kompliziert.mpeg}
...
\frame {
    ...
    \begin{center}
    \includemovie[poster,autoplay,controls=true]{7.5cm}{7.5cm}{quasiperiodisch.mpeg}
...
\frame {
    ...
    \begin{center}
    \includemovie[poster,autoplay,controls=true]{11cm}{5.5cm}{chaos.mpeg}
