...
\titlegraphic{\includegraphics[scale=0.3]{gluehwein.jpg}}
...
\frame {
    ...
    \vfill
    \hfill
    \includegraphics[scale=0.2]{promill.jpg}
}
...
\frame {
    ...
    \vfill
    \hfill
    \includegraphics[scale=0.24]{patrick.jpg}
}
...
\frame {
    ...
    \begin{center}
    \includegraphics[scale=1.0]{abbau.pdf}
    \end{center}
}
...
\frame {
    ...
    \begin{center}
    \includegraphics[scale=1.0]{rausch_wodka1.pdf}
    \end{center}
    \end{itemize}
}
...
\frame {
    ...
    \vfill
    \hfill
    \includegraphics[scale=0.75]{rausch_wodka2.pdf}
}
...
\frame {
    ...
    \begin{center}
    \includegraphics[scale=1]{wodka_konst.pdf}
    \end{center}
}
...
\frame {
    ...
    \begin{center}
    \includegraphics[scale=1]{bier.pdf}
    \end{center}
}
...
\frame {
    ...
    \begin{center}
    \includegraphics[scale=0.9]{bier_auto1.pdf}
    \end{center}
}
...
\frame {
    ...
    \begin{center}
    \includegraphics[scale=0.9]{bier_auto2.pdf}
    \end{center}
}
...
\frame {
    ...
    \hfil
    \hfil
    \includegraphics[scale=0.023]{neujahr.jpg}
}
